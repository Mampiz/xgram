const TrendingSection = () => {
	return (
		<div className="max-w-sm rounded-lg bg-white overflow-hidden shadow-lg m-4">
			<div className="flex">
				<div className="flex-1 m-2">
					<h2 className="px-4 py-2 text-xl w-48 font-semibold text-black">Spain trends</h2>
				</div>
				<div className="flex-1 px-4 py-2 m-2">
					<a href="#" className="text-2xl rounded-full text-black hover:bg-blue-800 hover:text-blue-300 float-right">
			...
			<div className="flex">
				<div className="flex-1">
					...
					<h2 className="px-4 ml-2 w-48 font-bold text-black">#Microsoft363</h2>
			...
			<div className="flex">
				<div className="flex-1">
					...
					<h2 className="px-4 ml-2 w-48 font-bold text-black">#HI-Fashion</h2>
				...
				<div className="flex-1">
					<div className="flex items-center w-48">
						...
						<div className="ml-3 mt-3">
							<p className="text-base leading-6 font-medium text-black">Sonali Hirave</p>
							<p className="text-sm leading-5 font-medium text-gray-400 group-hover:text-gray-300 transition ease-in-out duration-150">@ShonaDesign</p>
						</div>
					</div>
				</div>
				<div className="flex-1 px-4 py-2 m-2">
					<a href="#" className="float-right">
						<button className="bg-transparent hover:bg-blue-500 text-black font-semibold hover:text-black py-2 px-4 border border-white hover:border-transparent rounded-full">Follow</button>
					</a>
				</div>
			</div>
			<hr className="border-gray-600" />
